...
REPLACE THIS INFO:
*/
const apiKey = 'MC1Uvu1bUUuDXbz1fkAALFh8CI5lKM6JpnMxE66G5rCt9peOJxWru4B2mxQ0';
const prompt = 'black coloured mustang, portrait, ultra realistic, futuristic background , concept art, intricate details, highly detailed';
const numberOfPics = '2'
...
async function generateArt() {
    ...
    picAmount =result.data.output.length
    let i = 0;
    for (i; i < picAmount; i++) {
      let number = i + 1;
